...
export const updateVehicle = async (
    ...
    const VehicleValidation = z.object({
        Vehicle_Id:z.string().nonempty("Vehicle Id is required."),
...
export const updateArrival = async (
    state: { message: string | null, errors?: Record<string, string[] | undefined> },
    formData: FormData
  ): Promise<Response> => {

    const ArrivalValidation = z.object({
        Arrival_Id: z.string().nonempty("Arrival Id is required."),
    ...
    try {
        ...
        const inputValues = {
                Arrival_Id: formData.get('Arrival_Id') as string,
        ...
        return { message: "Arrival Updated Successfully" };
...
export const updateEmployee = async (
    ...
    const EmployeeValidation = z.object({
        Agent_Id: z.string().nonempty("Agent Id is required."),
...
export const updateRegister = async (
    ...
    const AdminValidation = z.object({
        Admin_Id: z.string().nonempty("Admin Id is required."),
